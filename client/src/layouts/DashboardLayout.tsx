...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex flex-col h-screen bg-transparent overflow-hidden">
      {/* Top Header */}
      <header className="flex-shrink-0 flex items-center justify-between h-16 px-6 bg-transparent border-b border-gray-200/50 dark:border-gray-800/50 z-10">
        <div className="flex items-center gap-3">
          <Link to="/" className="p-2 text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 dark:text-gray-400 dark:hover:text-orange-400 dark:hover:bg-orange-900/20 rounded-xl transition-colors" title="Home">
