...
import { Calendar as CalendarIcon, CheckCircle2, Clock, StickyNote, Files, Wallet, ShieldAlert, User, XCircle, Loader2, Database } from 'lucide-react';
...
const FEATURES = [
  ...
  { name: 'QA', href: '/qna', icon: Database, color: 'text-teal-500', bg: 'bg-teal-100 dark:bg-teal-900/30' },
